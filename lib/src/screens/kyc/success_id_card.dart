...
class SuccessIdCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        SizedBox(height: 10.h),
        _fieldInfo(context, "Id Type", "Personal Identity ID"),
        SizedBox(height: 5.h),
        _fieldInfo(context, "Country", "Syria"),
        SizedBox(height: 5.h),
        _fieldInfo(context, "Name", "De Bruijn"),
        SizedBox(height: 5.h),
        _fieldInfo(context, "National Number", "09982111123332"),
        SizedBox(height: 5.h),
        _fieldInfo(context, "Birthday", "01.01.1999"),
        SizedBox(height: 5.h),
  ...
  Widget _fieldInfo(BuildContext context, String title, String value) {
    return Container(
      decoration: BoxDecoration(
