...
class AppStrings {
  static const Map<String, Map<String, String>> _strings = {
    'en': {
      ...
      'view_all': 'View All',
      'linked_devices_last_active': 'Last active: {time}',
      ...
      'login_os': 'Operating System',
      'login_device': 'Device',
      'login_user_agent': 'User Agent',
      'login_city': 'City',
      'login_country': 'Country',
      'login_ip': 'IP Address',
      'login_history_load_failed': 'Failed to load login history',
      'login_history_empty': 'Your login history is empty',
      ...
      'linked_devices_title': 'Link a New Device',
      'linked_devices_description':
          'You can link your account to the web wallet by scanning the QR code from your wallet settings in the browser.',
      'linked_devices_scan_title': 'Scan QR code',
      'linked_devices_scan_hint':
          'Place the QR code inside the frame to link your device.',
      ...
      'add_second_phone_number': 'Add A Second Phone Number',
      'enter_phone_number_you_own': 'Enter A Phone Number That You Own',
      ...
      'first_phone_requires_verification':
          'The First Phone Number Is Essential For Identity Verification And Account Ownership, Therefore It Is Under Our Strong Protection.\nChanging Or Adding A Phone Number Requires A Video Call To Verify \nYour Identity.',
      'need_help_about_my_number': 'Need Help About My Number',
      ...
      'kyc_no_info_try_again': 'Couldn\'t read your details. Please try again.',
    ...
    'ar': {
      ...
      'linked_devices_last_active': 'آخر نشاط: {time}',
      ...
      'failed': 'فشل',
      'all': 'الكل',
      'login_method': 'الطريقة',
      'login_browser': 'المتصفح',
      'login_os': 'نظام التشغيل',
      'login_device': 'الجهاز',
      'login_user_agent': 'وكيل المستخدم',
      'login_city': 'المدينة',
      'login_country': 'الدولة',
      'login_ip': 'عنوان IP',
      'login_history_load_failed': 'فشل تحميل سجل الدخول',
      'login_history_empty': 'قائمة سجل الدخول فارغة',
      'withdrawal': 'سحب',
      'refund': 'استرداد',
      'order': 'طلب',
      'invoice': 'فاتورة',
      ...
      'linked_devices_title': 'ربط جهاز جديد',
      'linked_devices_description':
          'يمكنك ربط حسابك بمتصفح الويب عبر مسح رمز QR الموجود في إعدادات المحفظة على الويب.',
      'linked_devices_scan_title': 'مسح رمز QR',
      'linked_devices_scan_hint': 'ضع رمز QR داخل الإطار لربط جهازك.',
      ...
      'client_id_label': 'معرف العميل ID',
      'client_status': 'حالة العميل',
      'client_since': 'منذ الانضمام',
      'client_since_value': '23 يوم',
      'client_type': 'نوع العميل',
      'client_type_personal': 'شخصي',
      'client_verified': 'توثيق العميل',
      'client_name': 'اسم العميل',
      'client_phone_number': 'رقم هاتف العميل',
      'delete_my_account_request': 'طلب حذف حسابي',
      'name_must_match_personal_identification':
          'يجب أن يطابق الاسم وثيقة الهوية الشخصية',
      'guarantee_funds_official_document':
          'لضمان ملكية الأموال في الحساب. وعند استلام أي مبلغ من المراكز، لن يتم التسليم إلا بعد إبراز وثيقة رسمية مطابقة.',
      'add_second_phone_number': 'إضافة رقم هاتف ثاني',
      'enter_phone_number_you_own': 'أدخل رقم هاتف تملكه',
      'advise_enter_secure_phone':
          'ننصحك بشدة بإدخال رقم هاتف تملكه ولا يمكن سرقته، وأن لا يكون رقمك متاحاً للآخرين.',
      'phone_important_for_verification':
          'رقم الهاتف مهم جداً للتحقق من ملكية الحساب',
      'first_phone_requires_verification':
          'رقم الهاتف الأول أساسي للتحقق من الهوية وملكية الحساب، لذلك هو تحت حماية قوية لدينا.\nتغيير أو إضافة رقم هاتف يتطلب مكالمة فيديو للتحقق من هويتك.',
      'need_help_about_my_number': 'أحتاج مساعدة بخصوص رقمي',
      ...
      'kyc_no_info_try_again': 'لم يتم الحصول على المعلومات، حاول مجدداً.',
    ...
    'ku': {
      ...
      'deposit_requests': 'داواکاری داخیڵکردن',
      'status': 'دۆخ',
      'amount': 'بەرھەم',
      'date': 'بەرواری',
      ...
      'all': 'هەموو',
      'login_method': 'شێواز',
      'login_browser': 'وێبگەڕ',
      'login_os': 'سیستەمی کارپێکردن',
      'login_device': 'ئامێر',
      'login_user_agent': 'ناسنامەی بەکارهێنەر',
      'login_city': 'شار',
      'login_country': 'وڵات',
      'login_ip': 'ناونیشانی IP',
      'login_history_load_failed': 'بارکردنی مێژووی چوونەژوورەوە سەرکەوتوو نەبوو',
      'login_history_empty': 'مێژووی چوونەژوورەوەت بەتاڵە',
      'withdrawal': 'ڕاکێشان',
      'refund': 'گێڕانەوە',
      'order': 'داواکاری',
      'invoice': 'وەسڵ',
      ...
      'kurdish': 'کوردی',
      'turkish': 'Türkçe',
      'linked_devices': 'ئامێرە گەڕاوەکان',
      'linked_devices_title': 'پەیوەستکردنی ئامێرەی نوێ',
      'linked_devices_description':
          'دەتوانیت هەژمارەکەت بە وێب دەرگەی وێب بە سکانکردنی کۆدی QR لە دانانی پارەدانەکەت لە وێب پەیوەست بکەیت.',
      'linked_devices_scan_title': 'کۆدی QR بسکانێنە',
      'linked_devices_scan_hint':
      ...
      'permission_required': 'مۆڵەت پێویستە',
      'open_settings': 'کردنەوەی ڕێکخستنەکان',
      'camera_unavailable': 'کامێرا بەردەست نییە',
      'preview_crop': 'پێشبینین و بڕین',
      'crop': 'بڕین',
      'use_photo': 'بەکارهێنانی وێنە',
      'client_information': 'زانیاری کڕیار',
      'client_id_label': 'ناسنامەی کڕیار ID',
      'client_status': 'دۆخی کڕیار',
      'client_since': 'ئەندامە لە',
      'client_since_value': '23 ڕۆژ',
      'client_type': 'جۆری کڕیار',
      'client_type_personal': 'کەسی',
      'client_verified': 'پشتڕاستکردنەوەی کڕیار',
      'client_name': 'ناوی کڕیار',
      'client_phone_number': 'ژمارەی مۆبایلی کڕیار',
      'delete_my_account_request': 'داواکاری سڕینەوەی هەژمارەکەم',
      'name_must_match_personal_identification':
          'ناوەکە دەبێت لەگەڵ بەڵگەی ناسنامەی کەسی یەکبگرێت',
      'guarantee_funds_official_document':
          'بۆ دڵنیابوون لە خاوەندارێتی پارەکەی ناو هەژمار. هەروەها کاتێک پارە لە ناوەندەکان وەردەگیرێت، تەنها بە پیشاندانی بەڵگەنامەی فەرمی یەکگرتوو دەدرێت.',
      'add_second_phone_number': 'زیادکردنی ژمارەی مۆبایلی دووەم',
      'enter_phone_number_you_own': 'ژمارەیەک بنووسە کە خۆت خاوەنی',
      'advise_enter_secure_phone':
          'زۆر پێشنیارت دەکەین ژمارەیەک بنووسیت کە خۆت خاوەنی و نەتوانرێت بزدریت، هەروەها بۆ خەڵکی تر بەردەست نەبێت.',
      'phone_important_for_verification':
          'ژمارەی مۆبایل زۆر گرنگە بۆ پشتڕاستکردنەوەی خاوەندارێتی هەژمار',
      'first_phone_requires_verification':
          'یەکەم ژمارەی مۆبایل بنەڕەتییە بۆ پشتڕاستکردنەوەی ناسنامە و خاوەندارێتی هەژمار، بۆیە ژێر پاراستنی توندی ئێمەیە.\nگۆڕینی یان زیادکردنی ژمارەی مۆبایل پێویستی بە پەیوەندی ڤیدیۆیی هەیە بۆ پشتڕاستکردنەوەی ناسنامەت.',
      'need_help_about_my_number':
          'پێویستم بە یارمەتی هەیە سەبارەت بە ژمارەکەم',

      // Request Flow
      'payment_request': 'داواکاری پارەدان',
      'generate_request': 'دروستکردنی داواکاری',
      'requesting': 'جاري داواکردن...',
      ...
      'kyc_no_info_try_again': 'زانیارییەکان وەرنەگیران، تکایە دووبارە هەوڵ بدەرەوە.',
      'kyc_flip_to_back':
    ...
    'tr': {
      ...
      'linked_devices_last_active': 'Bağlı Cihazlar - Son Aktif {time}',
      'deposit': 'Yatırma',
      ...
      'all': 'Tümü',
      'login_method': 'Yöntem',
      'login_browser': 'Tarayıcı',
      'login_os': 'İşletim Sistemi',
      'login_device': 'Cihaz',
      'login_user_agent': 'Kullanıcı Aracısı',
      'login_city': 'Şehir',
      'login_country': 'Ülke',
      'login_ip': 'IP Adresi',
      'login_history_load_failed': 'Giriş geçmişi yüklenemedi',
      'login_history_empty': 'Giriş geçmişiniz boş',
      ...
      'linked_devices_title': 'Yeni Cihazı Bağla',
      'linked_devices_description':
          'Tarayıcıdaki cüzdan ayarlarında bulunan QR kodunu tarayarak hesabınızı web cüzdanına bağlayabilirsiniz.',
      'linked_devices_scan_title': 'QR kodu tara',
      'linked_devices_scan_hint':
      ...
      'client_information': 'Musteri Bilgileri',
      'client_id_label': 'Musteri ID',
      'client_status': 'Musteri Durumu',
      'client_since': 'Musteri Olma Suresi',
      'client_since_value': '23 Gun',
      'client_type': 'Musteri Turu',
      'client_type_personal': 'Bireysel',
      'client_verified': 'Musteri Dogrulamasi',
      'client_name': 'Musteri Adi',
      'client_phone_number': 'Musteri Telefon Numarasi',
      'delete_my_account_request': 'Hesabimi Silme Talebi',
      'name_must_match_personal_identification':
          'Ad, resmi kimlik bilgileriyle eslesmelidir',
      'guarantee_funds_official_document':
          'Hesaptaki fonlarin sahipligini garanti etmek icin. Ayrica merkezlerden para teslim alirken, eslesen resmi belge gosterilmeden teslim edilmez.',
      'add_second_phone_number': 'Ikinci Bir Telefon Numarasi Ekle',
      'enter_phone_number_you_own':
          'Sahip Oldugunuz Bir Telefon Numarasi Girin',
      'advise_enter_secure_phone':
          'Size ait olan, calinamayacak ve baskalari tarafindan erisilemeyecek bir telefon numarasi girmenizi siddetle oneririz.',
      'phone_important_for_verification':
          'Telefon numarasi hesap sahipligini dogrulamak icin cok onemlidir',
      'first_phone_requires_verification':
          'Ilk telefon numarasi kimlik ve hesap sahipligi dogrulamasi icin esastir, bu nedenle guclu korumamiz altindadir.\nTelefon numarasi degistirmek veya eklemek, kimliginizi dogrulamak icin goruntulu arama gerektirir.',
      'need_help_about_my_number': 'Numaramla Ilgili Yardima Ihtiyacim Var',
      ...
      'kyc_no_info_try_again': 'Bilgiler alınamadı. Lütfen tekrar deneyin.',
